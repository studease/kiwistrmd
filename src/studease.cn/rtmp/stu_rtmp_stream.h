...
stu_rtmp_frame_t  *stu_rtmp_stream_append(stu_rtmp_stream_t *s, stu_uint8_t type, stu_uint32_t timestamp, stu_rtmp_frame_info_t *info, u_char *data, size_t len);
