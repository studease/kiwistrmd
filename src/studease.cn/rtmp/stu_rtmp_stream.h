...
stu_int32_t  stu_rtmp_set_data_frame(stu_rtmp_stream_t *ns, stu_str_t *key, stu_rtmp_amf_t *value);
stu_int32_t  stu_rtmp_clear_data_frame(stu_rtmp_stream_t *ns, stu_str_t *key);
