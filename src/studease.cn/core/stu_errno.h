...
#ifndef STUDEASE_CN_CORE_STU_ERRNO_H_
#define STUDEASE_CN_CORE_STU_ERRNO_H_
...
u_char     *stu_strerror(stu_int32_t err, u_char *explain, size_t size);
stu_int32_t stu_strerror_init(void);

#endif /* STUDEASE_CN_CORE_STU_ERRNO_H_ */
